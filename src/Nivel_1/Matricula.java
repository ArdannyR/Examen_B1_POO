...
public class Matricula extends Evaluacion {
    ...
    public Matricula inscripcion(Scanner sc) {
        ...
        if (calificacion < 0 || calificacion > 10) {
            do {
                System.out.println("Error: Ingrese calificacion del curso: "); calificacion = sc.nextDouble(); sc.nextLine();
    ...
    public void mostrar() {
        System.out.printf("Matriculacion: %b Calificacion: %.2f", matricula, calificacion);
    }
